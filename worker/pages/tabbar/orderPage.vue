                ...
                <view class="orderPage-importentMsg">
                    ...
                    <view class="orderPage-importentMsgItem">
                        ...
                        <button @click="getImg" class="orderPage-chooseImg" type="default">
                            ...
                            <image v-else :src="orderImage" mode="aspectFill" style="width: 100%; height: 100%; border-radius: 10rpx;"></image>
                        </button>
                    </view>
                    <!-- 图片上传状态 -->
                    <view v-if="uploadStatus" class="upload-status" :class="{'upload-success': uploadSuccess, 'upload-error': !uploadSuccess}">
                        {{ uploadStatusText }}
                    </view>
                </view>
